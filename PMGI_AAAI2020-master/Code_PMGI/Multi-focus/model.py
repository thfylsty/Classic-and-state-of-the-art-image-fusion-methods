...
class CGAN(object):
  ...
  def build_model(self):
    ...
    with tf.name_scope('g_loss'):
        ...
        self.g_loss_2=2*tf.reduce_mean(tf.square(self.fusion_image - self.labels_ir))+2*tf.reduce_mean(tf.square(self.fusion_image - self.labels_vi))+3*tf.reduce_mean(tf.square(gradient(self.fusion_image) -gradient (self.labels_vi)))+3*tf.reduce_mean(tf.square(gradient(self.fusion_image) -gradient (self.labels_ir)))
