...
def main():
	...
	if IS_TRAINING:
		...
		original_imgs_path = list_images('../../../../Disk_B/MSCOCO2014/train2014')
		validatioin_imgs_path = list_images('../../../../Disk_B/MSCOCO2014/train2014')
		...
		if IS_VIDEO:
			...
			for i in range(10):
				index = i + 1
				infrared = path + 'Test_ir/' + str(index) + '.bmp'
				visible = path + 'Test_vi/' + str(index) + '.bmp'
				...
				output_save_path = 'outputs'
				generate(infrared, visible, model_path, model_pre_path,
						 ssim_weight, index, IS_VIDEO, is_RGB, type = 'addition', output_path = output_save_path)
				generate(infrared, visible, model_path, model_pre_path,
						 ssim_weight, index, IS_VIDEO, is_RGB, type='l1', output_path=output_save_path)
				generate(infrared, visible, model_path, model_pre_path,
						 ssim_weight, index, IS_VIDEO, is_RGB, type = 'channel', output_path = output_save_path)
